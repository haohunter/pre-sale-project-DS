    ...
    >
      <Container>
        <Typography
          variant="body1"
          color="primary.main"
          sx={{ mb: 1, fontWeight: 600, textAlign: "left" }}
        >
          Let's Get started
        </Typography>
        <Typography
          ...
          component="div"
          color="text.primary"
          sx={{ fontWeight: "600", pb: 6, textAlign: "left" }}
        >
          How to get <span class="gradient-on-span-mask">$ELO</span>
        </Typography>
        <Grid container spacing={0} justifyContent="center">
          ...
          <Grid item md={5}  >
              ...
              <img src={phones} alt="ELO logo" className="animated-image"  />
